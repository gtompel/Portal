...
const performanceData = [
  ...
  { month: "Июл", выполнено: 70, план: 70 },
  { month: "Авг", выполнено: 75, план: 75 },
  { month: "Сен", выполнено: 68, план: 80 },
  { month: "Окт", выполнено: 82, план: 85 },
  { month: "Ноя", выполнено: 87, план: 90 },
  { month: "Дек", выполнено: 92, план: 95 },
]
